...
/**
 * Validation Lists is a container for several lists of elements classified in:
...
public class ValidationLists<E> {
	...
	private ValidationLists(final List<E> valid, final List<E> invalid, final List<E> conflicted) {
		super();
                //System.out.println("Valids Invalids and Conflicts "+valid.size()+" "+invalid.size()+"  "+conflicted.size());
